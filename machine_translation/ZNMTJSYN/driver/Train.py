...
if __name__ == '__main__':
    ...
    dep_vec = dep_vocab.create_pretrained_embs(parser_config.pretrained_embeddings_file)
    ...
    # model
    nmt_model = eval(config.model_name)(config, parser_config, src_vocab.size, tgt_vocab.size, config.use_cuda)
    ...
    nmt = NMTHelper(nmt_model, parser_model, critic, src_vocab, tgt_vocab, dep_vocab, config, parser_config)
