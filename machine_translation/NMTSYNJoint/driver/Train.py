...
if __name__ == '__main__':
    ...
    # model
    nmt_model = eval(config.model_name)(config, parser_config, src_vocab, tgt_vocab, config.use_cuda)
    ...
    nmt = NMTHelper(nmt_model, parser_model, critic, src_vocab,
                    tgt_vocab, dep_vocab, config, parser_config)
