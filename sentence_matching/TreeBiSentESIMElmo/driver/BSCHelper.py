...
class BiSententClassifier(object):
    ...
    def forward(self, tinputs, src_forms, tgt_forms):
        src_words, src_rels, src_heads, src_lens, src_masks, \
        tgt_words, tgt_rels, tgt_heads, tgt_lens, tgt_masks = tinputs

        src_elmos, _ = self.get_elmo(src_forms)
        tgt_elmos, _ = self.get_elmo(tgt_forms)

        new_inputs = (src_words, src_elmos, src_rels, src_heads, src_lens, src_masks, \
                      tgt_words, tgt_elmos, tgt_rels, tgt_heads, tgt_lens, tgt_masks)
