...
class BiLSTMModel(nn.Module):
    def __init__(self, vocab, config, parser_config, init_embedding, elmo_shape):
    ...
    def forward(self, tinputs):
        ##unpack inputs
        src_words, src_elmos, src_isyns, src_lens, src_masks, \
        tgt_words, tgt_elmos, tgt_isyns, tgt_lens, tgt_masks = tinputs
        ...
        src_embed = torch.cat([src_dyn_embed, src_elmo_embed, src_syn], dim=-1)
        tgt_embed = torch.cat([tgt_dyn_embed, tgt_elmo_embed, tgt_syn], dim=-1)
