...
class BiSententClassifier(object):
    ...
    def forward(self, tinputs):
        src_words, src_extwords, src_rels, src_heads, src_lens, src_masks, \
        tgt_words, tgt_extwords, tgt_rels, tgt_heads, tgt_lens, tgt_masks = tinputs

        src_ext_embs = self.extword_embed(src_extwords)
        tgt_ext_embs = self.extword_embed(tgt_extwords)

        new_inputs = (src_words, src_ext_embs, src_rels, src_heads, src_lens, src_masks, \
                      tgt_words, tgt_ext_embs, tgt_rels, tgt_heads, tgt_lens, tgt_masks)
