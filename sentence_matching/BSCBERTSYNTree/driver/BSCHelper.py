...
class BiSententClassifier(object):
    ...
    def forward(self, tinputs):
        ...
        src_rels, src_heads, src_lens, src_masks, \
        tgt_bert_indices, tgt_bert_segments, tgt_bert_pieces, \
        tgt_rels, tgt_heads, tgt_lens, tgt_masks = tinputs
        ...
        new_inputs = (src_bert_outputs, src_rels, src_heads, src_lens, src_masks, \
                      tgt_bert_outputs, tgt_rels, tgt_heads, tgt_lens, tgt_masks)
