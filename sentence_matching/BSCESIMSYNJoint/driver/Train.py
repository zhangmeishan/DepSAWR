...
if __name__ == '__main__':
    ...
    argparser.add_argument('--config_file', default='msr/default.cfg')
    ...
    model = BiLSTMModel(vocab, config, parser_config, vec1)
    ...
    classifier = BiSententClassifier(model, extword_embed, vocab, parser_model, parser_extembed)
