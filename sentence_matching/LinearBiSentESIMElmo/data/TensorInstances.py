...
class TensorInstances:
    def __init__(self, batch_size, slen, tlen):
        ...
        self.src_actions = Variable(torch.LongTensor(batch_size, slen).zero_(), requires_grad=False)
        ...
        self.tgt_actions = Variable(torch.LongTensor(batch_size, tlen).zero_(), requires_grad=False)
