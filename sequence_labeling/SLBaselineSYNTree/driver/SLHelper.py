class SequenceLabeler(object):
    ...
    def forward(self, words, extwords, predicts, masks, rels, heads, lengths):
        ...
        label_scores = self.model.forward(words, extwords, predicts, masks, rels, heads, lengths)
        # cache
    ...
    def labeler(self, words, extwords, predicts, masks, rels, heads, lengths):
        if words is not None:
            self.forward(words, extwords, predicts, masks, rels, heads, lengths)
