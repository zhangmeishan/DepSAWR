...
class Configurable(object):
    ...
    def bert_config(self):
        return self._config.get('Data', 'bert_config')
    ...
    @property
    def bert_layers(self):
        return self._config.getint('Network', 'bert_layers')
    ...
    def parser_tune(self):
        return self._config.getint('Network', 'parser_tune')

    @property
    def bert_tune(self):
        return self._config.getint('Network', 'bert_tune')
