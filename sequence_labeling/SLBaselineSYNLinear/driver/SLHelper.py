class SequenceLabeler(object):
    ...
    def forward(self, words, extwords, predicts, masks, indices):
        ...
        label_scores = self.model.forward(words, extwords, predicts, masks, indices)
        # cache
    ...
    def labeler(self, words, extwords, predicts, masks, indices, wmasks):
        if words is not None:
            self.forward(words, extwords, predicts, masks, indices)
