class SequenceLabeler(object):
    ...
    def forward(self, words, predicts, masks, rels, heads, lengths):
        ...
        label_scores = self.model.forward(elmos, predicts, masks, rels, heads, lengths)
        # cache
    ...
    def labeler(self, words, predicts, masks, rels, heads, lengths):
        if words is not None:
            self.forward(words, predicts, masks, rels, heads, lengths)
