...
class SequenceLabeler(object):
    ...
    def forward(self, inputs, predicts, masks):
        ...
        label_scores = self.model.forward(bert_outputs, predicts, masks)
        # cache
    ...
    def labeler(self, inputs, predicts, masks):
        if inputs is not None:
            self.forward(inputs, predicts, masks)
